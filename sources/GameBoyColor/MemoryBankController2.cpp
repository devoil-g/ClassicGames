...
GBC::MemoryBankController2::MemoryBankController2(const std::vector<std::uint8_t>& rom, const std::string& ramSave) :
  GBC::MemoryBankController(rom, GBC::MemoryBankController2::RamSize, ramSave)
{}
