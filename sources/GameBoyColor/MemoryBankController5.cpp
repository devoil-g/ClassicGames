...
GBC::MemoryBankController5::MemoryBankController5(GBC::GameBoyColor& gbc, const std::vector<std::uint8_t>& rom, std::size_t ramSize, const std::filesystem::path& ramSave) :
