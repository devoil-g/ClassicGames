  ...
  _lighting(nullptr)
{
  ...
  case DOOM::Doom::Level::Sector::Special::LightBlink05:
    _lighting.reset(new DOOM::BlinkLightingAction<15, 5, false>());
    break;
  case DOOM::Doom::Level::Sector::Special::LightBlink10:
    _lighting.reset(new DOOM::BlinkLightingAction<35, 5, false>());
    break;
  ...
  case DOOM::Doom::Level::Sector::Special::DoorClose:
    _leveling.reset(new DOOM::DoorLevelingAction<DOOM::EnumAction::Speed::SpeedSlow, 1050>({ DOOM::EnumAction::State::StateWait, DOOM::EnumAction::State::StateClose }));
    break;
  case DOOM::Doom::Level::Sector::Special::End:
    break;	// TODO
  case DOOM::Doom::Level::Sector::Special::LightBlink05Sync:
    _lighting.reset(new DOOM::BlinkLightingAction<15, 5, true>());
    break;
  case DOOM::Doom::Level::Sector::Special::LightBlink10Sync:
    _lighting.reset(new DOOM::BlinkLightingAction<35, 5, true>());
    break;
  case DOOM::Doom::Level::Sector::Special::DoorOpen:
    _leveling.reset(new DOOM::DoorLevelingAction<DOOM::EnumAction::Speed::SpeedSlow, 10500>({ DOOM::EnumAction::State::StateWait, DOOM::EnumAction::State::StateOpen }));
    break;
...
void	DOOM::Doom::Level::Sector::leveling(std::unique_ptr<DOOM::Doom::Level::Sector::AbstractAction> && action)
{
  // Push action if leveling slot available
  if (_leveling.get() == nullptr)
    _leveling = std::move(action);
}
...
void	DOOM::Doom::Level::Sector::lighting(std::unique_ptr<DOOM::Doom::Level::Sector::AbstractAction> && action)
{
  // Push action if lighting slot available
  if (_lighting.get() == nullptr)
    _lighting = std::move(action);
}
...
std::unique_ptr<DOOM::Doom::Level::Sector::AbstractAction>	DOOM::Doom::Level::Sector::AbstractAction::factory(DOOM::Doom::Level::Sector & sector, int16_t type)
{
  ...
  case 1: case 4: case 29: case 63: case 90:	// Open, wait then close (slow)
    return std::make_unique<DOOM::DoorLevelingAction<DOOM::EnumAction::Speed::SpeedSlow, 140>>(std::list<DOOM::EnumAction::State>({ DOOM::EnumAction::State::StateOpen, DOOM::EnumAction::State::StateWait, DOOM::EnumAction::State::StateClose }));
  case 105: case 108: case 111: case 114: case 117:	// Open, wait then close (fast)
    return std::make_unique<DOOM::DoorLevelingAction<DOOM::EnumAction::Speed::SpeedFast, 140>>(std::list<DOOM::EnumAction::State>({ DOOM::EnumAction::State::StateOpen, DOOM::EnumAction::State::StateWait, DOOM::EnumAction::State::StateClose }));
  case 2: case 31: case 46: case 61: case 86: case 103:	// Open and stay open (slow)
    return std::make_unique<DOOM::DoorLevelingAction<DOOM::EnumAction::Speed::SpeedSlow>>(std::list<DOOM::EnumAction::State>({ DOOM::EnumAction::State::StateOpen }));
  case 106: case 109: case 112: case 115: case 118:	// Open and stay open (fast)
    return std::make_unique<DOOM::DoorLevelingAction<DOOM::EnumAction::Speed::SpeedFast>>(std::list<DOOM::EnumAction::State>({ DOOM::EnumAction::State::StateOpen }));
  case 16: case 76: case 175: case 196:	// Close, wait then open (slow)
    return std::make_unique<DOOM::DoorLevelingAction<DOOM::EnumAction::Speed::SpeedNormal, 1050>>(std::list<DOOM::EnumAction::State>({ DOOM::EnumAction::State::StateClose, DOOM::EnumAction::State::StateWait, DOOM::EnumAction::State::StateOpen }));
  case 3: case 42: case 50: case 75:	// Close and stay close (slow)
    return std::make_unique<DOOM::DoorLevelingAction<DOOM::EnumAction::Speed::SpeedSlow>>(std::list<DOOM::EnumAction::State>({ DOOM::EnumAction::State::StateClose }));
  case 107: case 110: case 113: case 116:	// Close and stay close (fast)
    return std::make_unique<DOOM::DoorLevelingAction<DOOM::EnumAction::Speed::SpeedFast>>(std::list<DOOM::EnumAction::State>({ DOOM::EnumAction::State::StateClose }));
  ...
  case 58: case 92:	// Absolute 24 (up, slow)
    return std::make_unique<DOOM::FloorLevelingAction<DOOM::EnumAction::Direction::DirectionUp, DOOM::EnumAction::Speed::SpeedSlow, DOOM::EnumAction::Crush::CrushFalse>>(sector.baseFloor() + 24.f);
  case 59: case 93:
    break;	// TODO: TxTy
  case 140:	// Absolute 512 (up, slow)
    return std::make_unique<DOOM::FloorLevelingAction<DOOM::EnumAction::Direction::DirectionUp, DOOM::EnumAction::Speed::SpeedSlow, DOOM::EnumAction::Crush::CrushFalse>>(sector.baseFloor() + 512.f);
  case 19: case 45: case 83: case 102: {	// Highest neighboor floor (down, slow)
    float	height = sector.getNeighborHighestFloor();
    return std::make_unique<DOOM::FloorLevelingAction<DOOM::EnumAction::Direction::DirectionDown, DOOM::EnumAction::Speed::SpeedSlow, DOOM::EnumAction::Crush::CrushFalse>>(std::isnan(height) == true ? -32000.f : height);
  }
  case 36: case 70: case 71: case 98: {	// Highest neighboor floor + 8 (down, fast)
    float	height = sector.getNeighborHighestFloor();
    return std::make_unique<DOOM::FloorLevelingAction<DOOM::EnumAction::Direction::DirectionDown, DOOM::EnumAction::Speed::SpeedFast, DOOM::EnumAction::Crush::CrushFalse>>((std::isnan(height) == true ? -32000.f : height) + 8.f);
  }
  case 5: case 24: case 64: case 91: case 101: {	// Lowest sector & neighboor ceiling (up, slow)
    float	height = sector.getNeighborHighestFloor();
    return std::make_unique<DOOM::FloorLevelingAction<DOOM::EnumAction::Direction::DirectionUp, DOOM::EnumAction::Speed::SpeedSlow, DOOM::EnumAction::Crush::CrushFalse>>((std::isnan(height) == true || height > sector.baseFloor()) ? sector.baseFloor() : height);
  }
  case 55: case 56: case 65: case 94: {	// Lowest sector & neighboor ceiling - 8 (up, slow, crush)
    float	height = sector.getNeighborHighestFloor();
    return std::make_unique<DOOM::FloorLevelingAction<DOOM::EnumAction::Direction::DirectionUp, DOOM::EnumAction::Speed::SpeedSlow, DOOM::EnumAction::Crush::CrushTrue>>(((std::isnan(height) == true || height > sector.baseFloor()) ? sector.baseFloor() : height) - 8.f);
  }
  case 23: case 38: case 60: case 82: {	// Lowest sector & neighboor floor (down, slow)
    float	height = sector.getNeighborLowestFloor();
    return std::make_unique<DOOM::FloorLevelingAction<DOOM::EnumAction::Direction::DirectionDown, DOOM::EnumAction::Speed::SpeedSlow, DOOM::EnumAction::Crush::CrushFalse>>((std::isnan(height) == true || height > sector.baseFloor()) ? sector.baseFloor() : height);
  }
  case 37: case 84:
    break;	// TODO: TxTy
  case 18: case 69: case 119: case 128: {	// Next neighboor floor (up, slow)
    float	height = sector.getNeighborNextHighestFloor(sector.baseFloor());
    return std::make_unique<DOOM::FloorLevelingAction<DOOM::EnumAction::Direction::DirectionUp, DOOM::EnumAction::Speed::SpeedSlow, DOOM::EnumAction::Crush::CrushFalse>>(std::isnan(height) == true ? sector.baseFloor() : height);
  }
  case 129: case 130: case 131: case 132: {	// Next neighboor floor (up, fast)
    float	height = sector.getNeighborNextHighestFloor(sector.baseFloor());
    return std::make_unique<DOOM::FloorLevelingAction<DOOM::EnumAction::Direction::DirectionUp, DOOM::EnumAction::Speed::SpeedFast, DOOM::EnumAction::Crush::CrushFalse>>(std::isnan(height) == true ? sector.baseFloor() : height);
  }

    // Regular ceiling types
  case 40: {	// Highest neighboor ceiling (up, slow)
    float	height = sector.getNeighborHighestCeiling();
    return std::make_unique<DOOM::CeilingLevelingAction<DOOM::EnumAction::Direction::DirectionUp, DOOM::EnumAction::Speed::SpeedSlow, DOOM::EnumAction::Crush::CrushFalse>>(std::isnan(height) == true ? -32000.f : height);
  }
  case 41: case 43:	// Floor (down, fast)
    return std::make_unique<DOOM::CeilingLevelingAction<DOOM::EnumAction::Direction::DirectionDown, DOOM::EnumAction::Speed::SpeedFast, DOOM::EnumAction::Crush::CrushFalse>>(sector.baseFloor());
  case 44: case 72:	// Floor + 8 (down, slow)
    return std::make_unique<DOOM::CeilingLevelingAction<DOOM::EnumAction::Direction::DirectionDown, DOOM::EnumAction::Speed::SpeedSlow, DOOM::EnumAction::Crush::CrushFalse>>(sector.baseFloor() + 8.f);

    // Regular lighting
  case 17:	// Blinking
    return std::make_unique<DOOM::BlinkLightingAction<35, 5, false>>();
