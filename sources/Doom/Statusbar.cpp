...
void  DOOM::Statusbar::renderWeapons(const DOOM::Doom& doom, sf::Image& target, sf::Rect<int16_t> rect) const
{
  ...
  renderTexture(doom, target, rect, doom.resources.getMenu(DOOM::str_to_key(weapons.at(1) == true ? "STYSNUM2" : "STGNUM2")), 111, 4);
  renderTexture(doom, target, rect, doom.resources.getMenu(DOOM::str_to_key(weapons.at(2) == true ? "STYSNUM3" : "STGNUM3")), 123, 4);
  renderTexture(doom, target, rect, doom.resources.getMenu(DOOM::str_to_key(weapons.at(3) == true ? "STYSNUM4" : "STGNUM4")), 135, 4);
  renderTexture(doom, target, rect, doom.resources.getMenu(DOOM::str_to_key(weapons.at(4) == true ? "STYSNUM5" : "STGNUM5")), 111, 14);
  renderTexture(doom, target, rect, doom.resources.getMenu(DOOM::str_to_key(weapons.at(5) == true ? "STYSNUM6" : "STGNUM6")), 123, 14);
  renderTexture(doom, target, rect, doom.resources.getMenu(DOOM::str_to_key(weapons.at(6) == true ? "STYSNUM7" : "STGNUM7")), 135, 14);
}
