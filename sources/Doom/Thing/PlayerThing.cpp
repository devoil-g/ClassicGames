...
bool  DOOM::PlayerThing::pickup(DOOM::Doom& doom, DOOM::AbstractThing& item)
{
  ...
  static const std::unordered_map<DOOM::Enum::ThingType, std::function<bool(DOOM::Doom&, DOOM::PlayerThing&, DOOM::AbstractThing&)>> items = {
    ...
    { DOOM::Enum::ThingType::ThingType_CLIP, [](DOOM::Doom& doom, DOOM::PlayerThing& player, DOOM::AbstractThing& item) { return player.pickupAmmo(DOOM::Enum::Ammo::AmmoBullet, (item.flags & DOOM::Enum::ThingProperty::ThingProperty_Dropped) ? 5 : 10) && (doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_itemup), true); } },                                                                                                                       // Ammo clip
    ...
    { DOOM::Enum::ThingType::ThingType_MISC17, [](DOOM::Doom& doom, DOOM::PlayerThing& player, DOOM::AbstractThing& item) { return player.pickupAmmo(DOOM::Enum::Ammo::AmmoBullet, 50) && (doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_itemup), true); } },                                                                                                                                                                                           // Box of ammo
    { DOOM::Enum::ThingType::ThingType_MISC18, [](DOOM::Doom& doom, DOOM::PlayerThing& player, DOOM::AbstractThing& item) { return player.pickupAmmo(DOOM::Enum::Ammo::AmmoRocket, 1) && (doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_itemup), true); } },                                                                                                                                                                                            // Rocket
    { DOOM::Enum::ThingType::ThingType_MISC19, [](DOOM::Doom& doom, DOOM::PlayerThing& player, DOOM::AbstractThing& item) { return player.pickupAmmo(DOOM::Enum::Ammo::AmmoRocket, 1) && (doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_itemup), true); } },                                                                                                                                                                                            // Box of rockets
    { DOOM::Enum::ThingType::ThingType_MISC20, [](DOOM::Doom& doom, DOOM::PlayerThing& player, DOOM::AbstractThing& item) { return player.pickupAmmo(DOOM::Enum::Ammo::AmmoCell, 20) && (doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_itemup), true); } },                                                                                                                                                                                             // Cell charge
    { DOOM::Enum::ThingType::ThingType_MISC21, [](DOOM::Doom& doom, DOOM::PlayerThing& player, DOOM::AbstractThing& item) { return player.pickupAmmo(DOOM::Enum::Ammo::AmmoCell, 100) && (doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_itemup), true); } },                                                                                                                                                                                            // Cell charge pack
    { DOOM::Enum::ThingType::ThingType_MISC22, [](DOOM::Doom& doom, DOOM::PlayerThing& player, DOOM::AbstractThing& item) { return player.pickupAmmo(DOOM::Enum::Ammo::AmmoShell, 4) && (doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_itemup), true); } },                                                                                                                                                                                             // Shotgun shells
    { DOOM::Enum::ThingType::ThingType_MISC23, [](DOOM::Doom& doom, DOOM::PlayerThing& player, DOOM::AbstractThing& item) { return player.pickupAmmo(DOOM::Enum::Ammo::AmmoShell, 20) && (doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_itemup), true); } },                                                                                                                                                                                            // Box of shells
    { DOOM::Enum::ThingType::ThingType_MISC24, [](DOOM::Doom& doom, DOOM::PlayerThing& player, DOOM::AbstractThing& item) { return (player.pickupBackpack() | player.pickupAmmo(DOOM::Enum::Ammo::AmmoBullet, 10) | player.pickupAmmo(DOOM::Enum::Ammo::AmmoShell, 4) | player.pickupAmmo(DOOM::Enum::Ammo::AmmoRocket, 1) | player.pickupAmmo(DOOM::Enum::Ammo::AmmoCell, 20)) && (doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_itemup), true); } },  // Backpack
    { DOOM::Enum::ThingType::ThingType_MISC25, [](DOOM::Doom& doom, DOOM::PlayerThing& player, DOOM::AbstractThing& item) { return (player.pickupWeapon(DOOM::Enum::Weapon::WeaponBFG9000) | player.pickupAmmo(DOOM::Enum::Ammo::AmmoCell, 40)) && (doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_wpnup), true); } },                                                                                                                                   // BFG 9000
    { DOOM::Enum::ThingType::ThingType_CHAINGUN, [](DOOM::Doom& doom, DOOM::PlayerThing& player, DOOM::AbstractThing& item) { return (player.pickupWeapon(DOOM::Enum::Weapon::WeaponChaingun) | player.pickupAmmo(DOOM::Enum::Ammo::AmmoBullet, (item.flags & DOOM::Enum::ThingProperty::ThingProperty_Dropped) ? 10 : 20)) && (doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_wpnup), true); } },                                                       // Chaingun
    ...
    { DOOM::Enum::ThingType::ThingType_MISC27, [](DOOM::Doom& doom, DOOM::PlayerThing& player, DOOM::AbstractThing& item) { return (player.pickupWeapon(DOOM::Enum::Weapon::WeaponRocketLauncher) | player.pickupAmmo(DOOM::Enum::Ammo::AmmoRocket, 2)) && (doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_wpnup), true); } },                                                                                                                           // Rocket launcher
    { DOOM::Enum::ThingType::ThingType_MISC28, [](DOOM::Doom& doom, DOOM::PlayerThing& player, DOOM::AbstractThing& item) { return (player.pickupWeapon(DOOM::Enum::Weapon::WeaponPlasmaGun) | player.pickupAmmo(DOOM::Enum::Ammo::AmmoCell, 40)) && (doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_wpnup), true); } },                                                                                                                                 // Plasma rifle
    { DOOM::Enum::ThingType::ThingType_SHOTGUN, [](DOOM::Doom& doom, DOOM::PlayerThing& player, DOOM::AbstractThing& item) { return (player.pickupWeapon(DOOM::Enum::Weapon::WeaponShotgun) | player.pickupAmmo(DOOM::Enum::Ammo::AmmoShell, (item.flags & DOOM::Enum::ThingProperty::ThingProperty_Dropped) ? 4 : 8)) && (doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_wpnup), true); } },                                                            // Shotgun
    { DOOM::Enum::ThingType::ThingType_SUPERSHOTGUN, [](DOOM::Doom& doom, DOOM::PlayerThing& player, DOOM::AbstractThing& item) { return (player.pickupWeapon(DOOM::Enum::Weapon::WeaponSuperShotgun) | player.pickupAmmo(DOOM::Enum::Ammo::AmmoShell, (item.flags & DOOM::Enum::ThingProperty::ThingProperty_Dropped) ? 4 : 8)) && (doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_wpnup), true); } },                                                  // Super shotgun
  };
