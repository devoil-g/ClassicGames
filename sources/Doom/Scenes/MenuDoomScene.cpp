...
DOOM::MenuDoomScene::MenuDoomScene(Game::SceneMachine& machine, DOOM::Doom& doom, bool random) :
  ...
  _menuDesc({
    Menu{ // MenuMain
      .items = {
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("M_DOOM"), .selectable = false, .x = 94, .y = 2, .hotkey = Game::Window::Keyboard::Key::Unknown, .select = []() {}, .left = []() {}, .right = []() {} },
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("M_NGAME"), .selectable = true, .x = 97, .y = 64, .hotkey = Game::Window::Keyboard::Key::N, .select = [this]() { if (_doom.mode == DOOM::Enum::Mode::ModeCommercial) { _episode = 1; _menuIndex = MenuSkill; _menuCursor = _doom.skill + 2; } else { _menuIndex = MenuEpisode; _menuCursor = 1; } _doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_pistol); }, .left = []() {}, .right = []() {} },
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("M_OPTION"), .selectable = true, .x = 97, .y = 80, .hotkey = Game::Window::Keyboard::Key::O, .select = [this]() { _menuIndex = MenuOptions; _menuCursor = 2; _doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_pistol); }, .left = []() {}, .right = []() {} },
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("M_LOADG"), .selectable = false, .x = 97, .y = 96, .hotkey = Game::Window::Keyboard::Key::L, .select = []() {}, .left = []() {}, .right = []() {} },
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("M_SAVEG"), .selectable = false, .x = 97, .y = 112, .hotkey = Game::Window::Keyboard::Key::S, .select = []() {}, .left = []() {}, .right = []() {} },
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("M_RDTHIS"), .selectable = true, .x = 97, .y = 128, .hotkey = Game::Window::Keyboard::Key::R, .select = [this]() { _menuIndex = MenuRead1; _menuCursor = 0; _doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_pistol); }, .left = []() {}, .right = []() {} },
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("M_QUITG"), .selectable = true, .x = 97, .y = 144, .hotkey = Game::Window::Keyboard::Key::Q, .select = [this]() { _machine.clear(); }, .left = []() {}, .right = []() {} }
      },
      .sliders = {},
    ...
    Menu{ // MenuEpisode
      .items = {
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("M_EPISOD"), .selectable = false, .x = 54, .y = 38, .hotkey = Game::Window::Keyboard::Key::Unknown, .select = []() {}, .left = []() {}, .right = []() {} },
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("M_EPI1"), .selectable = true, .x = 48, .y = 63, .hotkey = Game::Window::Keyboard::Key::K, .select = [this]() { _episode = 1; _menuIndex = MenuSkill; _menuCursor = _doom.skill + 2; _doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_pistol); }, .left = []() {}, .right = []() {} },
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("M_EPI2"), .selectable = true, .x = 48, .y = 79, .hotkey = Game::Window::Keyboard::Key::T, .select = [this]() { _episode = 2; _menuIndex = MenuSkill; _menuCursor = _doom.skill + 2; _doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_pistol); }, .left = []() {}, .right = []() {} },
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("M_EPI3"), .selectable = true, .x = 48, .y = 95, .hotkey = Game::Window::Keyboard::Key::I, .select = [this]() { _episode = 3; _menuIndex = MenuSkill; _menuCursor = _doom.skill + 2; _doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_pistol); }, .left = []() {}, .right = []() {} },
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("M_EPI4"), .selectable = true, .x = 48, .y = 111, .hotkey = Game::Window::Keyboard::Key::T, .select = [this]() { _episode = 4; _menuIndex = MenuSkill; _menuCursor = _doom.skill + 2; _doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_pistol); }, .left = []() {}, .right = []() {} }
      },
      .sliders = {},
    ...
    Menu{ // MenuSkill
      .items = {
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("M_NEWG"), .selectable = false, .x = 96, .y = 14, .hotkey = Game::Window::Keyboard::Key::Unknown, .select = []() {}, .left = []() {}, .right = []() {} },
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("M_SKILL"), .selectable = false, .x = 54, .y = 38, .hotkey = Game::Window::Keyboard::Key::Unknown, .select = []() {}, .left = []() {}, .right = []() {} },
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("M_JKILL"), .selectable = true, .x = 48, .y = 63, .hotkey = Game::Window::Keyboard::Key::I, .select = [this]() { _doom.skill = DOOM::Enum::Skill::SkillBaby; _doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_pistol); start(); }, .left = []() {}, .right = []() {} },
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("M_ROUGH"), .selectable = true, .x = 48, .y = 79, .hotkey = Game::Window::Keyboard::Key::H, .select = [this]() { _doom.skill = DOOM::Enum::Skill::SkillEasy; _doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_pistol); start(); }, .left = []() {}, .right = []() {} },
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("M_HURT"), .selectable = true, .x = 48, .y = 95, .hotkey = Game::Window::Keyboard::Key::H, .select = [this]() { _doom.skill = DOOM::Enum::Skill::SkillMedium; _doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_pistol); start(); }, .left = []() {}, .right = []() {} },
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("M_ULTRA"), .selectable = true, .x = 48, .y = 111, .hotkey = Game::Window::Keyboard::Key::U, .select = [this]() { _doom.skill = DOOM::Enum::Skill::SkillHard; _doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_pistol); start(); }, .left = []() {}, .right = []() {} },
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("M_NMARE"), .selectable = true, .x = 48, .y = 127, .hotkey = Game::Window::Keyboard::Key::N, .select = [this]() { _doom.skill = DOOM::Enum::Skill::SkillNightmare; _doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_pistol); start(); }, .left = []() {}, .right = []() {} }
      },
      .sliders = {},
    ...
    Menu{ // MenuOptions
      .items = {
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("M_OPTTTL"), .selectable = false, .x = 108, .y = 15, .hotkey = Game::Window::Keyboard::Key::Unknown, .select = []() {}, .left = []() {}, .right = []() {} },
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("M_ENDGAM"), .selectable = false, .x = 60, .y = 37, .hotkey = Game::Window::Keyboard::Key::Unknown, .select = []() {}, .left = []() {}, .right = []() {} },
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("M_MESSG"), .selectable = true, .x = 60, .y = 53, .hotkey = Game::Window::Keyboard::Key::M, .select = [this]() { _doom.message = !_doom.message; std::next(_menuDesc[MenuOptions].items.begin(), 3)->texture = Game::Utilities::str_to_key<std::uint64_t>(_doom.message == true ? "M_MSGON" : "M_MSGOFF"); _doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_pistol); }, .left = []() {}, .right = []() {} },
        { .texture = Game::Utilities::str_to_key<std::uint64_t>(_doom.message == true ? "M_MSGON" : "M_MSGOFF"), .selectable = false, .x = 180, .y = 53, .hotkey = Game::Window::Keyboard::Key::Unknown, .select = [this]() {}, .left = []() {}, .right = []() {} },
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("M_DETAIL"), .selectable = true, .x = 60, .y = 69, .hotkey = Game::Window::Keyboard::Key::G, .select = [this]() { DOOM::Doom::RenderScale = DOOM::Doom::RenderScale % 2 + 1; std::next(_menuDesc[MenuOptions].items.begin(), 5)->texture = Game::Utilities::str_to_key<std::uint64_t>(DOOM::Doom::RenderScale == 1 ? "M_GDLOW" : "M_GDHIGH"); _doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_pistol); }, .left = []() {}, .right = []() {} },
        { .texture = Game::Utilities::str_to_key<std::uint64_t>(DOOM::Doom::RenderScale == 1 ? "M_GDLOW" : "M_GDHIGH"), .selectable = false, .x = 235, .y = 69, .hotkey = Game::Window::Keyboard::Key::Unknown, .select = [this]() {}, .left = []() {}, .right = []() {} },
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("M_SCRNSZ"), .selectable = false, .x = 60, .y = 85, .hotkey = Game::Window::Keyboard::Key::Unknown, .select = []() {}, .left = []() {}, .right = []() {} },
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("M_MSENS"), .selectable = true, .x = 60, .y = 117, .hotkey = Game::Window::Keyboard::Key::M, .select = [this]() { _doom.sensivity = std::clamp(((int)(_doom.sensivity * 8) + 1) / 8.f, 0.f, 1.f); _doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_stnmov); }, .left = [this]() { _doom.sensivity = std::clamp(((int)(_doom.sensivity * 8) - 1) / 8.f, 0.f, 1.f); _doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_stnmov); }, .right = [this]() { _doom.sensivity = std::clamp(((int)(_doom.sensivity * 8) + 1) / 8.f, 0.f, 1.f); _doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_stnmov); } },
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("M_SVOL"), .selectable = true, .x = 60, .y = 149, .hotkey = Game::Window::Keyboard::Key::S, .select = [this]() { _menuIndex = MenuVolume; _menuCursor = 1; _doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_pistol); }, .left = []() {}, .right = []() {} }
      },
      .sliders = {
    ...
    Menu{ // MenuRead1
      .items = {
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("HELP1"), .selectable = true, .x = 0, .y = 0, .hotkey = Game::Window::Keyboard::Key::Unknown, .select = [this]() { _menuIndex = MenuRead2; _menuCursor = 0; _doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_pistol); }, .left = []() {}, .right = []() {} }
      },
      .sliders = {},
    ...
    Menu{ // MenuRead2
      .items = {
        { .texture = Game::Utilities::str_to_key<std::uint64_t>("HELP2"), .selectable = true, .x = 0, .y = 0, .hotkey = Game::Window::Keyboard::Key::Unknown, .select = [this]() { _menuIndex = MenuMain; _menuCursor = 5; _doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_pistol); }, .left = []() {}, .right = []() {} }
      },
      .sliders = {},
      .escape = [this]() { _menuIndex = MenuMain; _menuCursor = 5; _doom.sound(DOOM::Doom::Resources::Sound::EnumSound::Sound_swtchn); }
    }
...
bool  DOOM::MenuDoomScene::update(float elapsed)
{
  ...
  const std::list<std::pair<bool, std::function<void()>>> actions =
    ...
    std::list<std::pair<bool, std::function<void()>>>{
      { Game::Window::Instance().keyboard().keyPressed(Game::Window::Keyboard::Key::Space) == true || Game::Window::Instance().keyboard().keyPressed(Game::Window::Keyboard::Key::Enter) == true, [this]() { updateSelect(); } },
      { Game::Window::Instance().keyboard().keyPressed(Game::Window::Keyboard::Key::Up) == true || Game::Window::Instance().keyboard().keyPressed(Game::Window::Keyboard::Key::Z) == true, [this]() { updateUp(); } },
      { Game::Window::Instance().keyboard().keyPressed(Game::Window::Keyboard::Key::Down) == true || Game::Window::Instance().keyboard().keyPressed(Game::Window::Keyboard::Key::S) == true, [this]() { updateDown(); } },
      { Game::Window::Instance().keyboard().keyPressed(Game::Window::Keyboard::Key::Left) == true || Game::Window::Instance().keyboard().keyPressed(Game::Window::Keyboard::Key::Q) == true, [this]() { updateLeft(); } },
      { Game::Window::Instance().keyboard().keyPressed(Game::Window::Keyboard::Key::Right) == true || Game::Window::Instance().keyboard().keyPressed(Game::Window::Keyboard::Key::D) == true, [this]() { updateRight(); } },
      { Game::Window::Instance().keyboard().keyPressed(Game::Window::Keyboard::Key::Escape) == true, [this]() { updateEscape(); } },
    }
    :
    std::list<std::pair<bool, std::function<void()>>>{
      { Game::Window::Instance().joystick().buttonPressed(controller - 1, 0) == true, [this]() { updateSelect(); } },
      { Game::Window::Instance().joystick().position(controller - 1, Game::Window::Joystick::Axis::PovY) > +0.9f && Game::Window::Instance().joystick().relative(controller - 1, Game::Window::Joystick::Axis::PovY) != 0.f, [this]() { updateUp(); } },
      { Game::Window::Instance().joystick().position(controller - 1, Game::Window::Joystick::Axis::PovY) < -0.9f && Game::Window::Instance().joystick().relative(controller - 1, Game::Window::Joystick::Axis::PovY) != 0.f, [this]() { updateDown(); } },
      { Game::Window::Instance().joystick().position(controller - 1, Game::Window::Joystick::Axis::PovX) < -0.9f && Game::Window::Instance().joystick().relative(controller - 1, Game::Window::Joystick::Axis::PovX) != 0.f, [this]() { updateLeft(); } },
      { Game::Window::Instance().joystick().position(controller - 1, Game::Window::Joystick::Axis::PovX) > +0.9f && Game::Window::Instance().joystick().relative(controller - 1, Game::Window::Joystick::Axis::PovX) != 0.f, [this]() { updateRight(); } },
